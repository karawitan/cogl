...
extern GType cogl_gst_video_sink_get_type(void);
extern GType cogl_gst_rectangle_get_gtype(void);
G_MODULE_EXPORT GType (*GI_GET_TYPE_FUNCS_[])(void) = {
  cogl_gst_video_sink_get_type,
  cogl_gst_rectangle_get_gtype
};
